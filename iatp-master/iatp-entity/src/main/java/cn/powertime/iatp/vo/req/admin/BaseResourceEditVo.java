...
@Data
public class BaseResourceEditVo implements Serializable {
    ...
    @ApiModelProperty(value = "是否默认打开 1：是，2：否", position = 3)
    ...
    @ApiModelProperty(value = "课程（实验）ID", position = 4)
    ...
    @ApiModelProperty(value = "小节ID", position = 6)
    ...
    @ApiModelProperty(value = "文件名称", position = 7)
     ...
     * 资源介绍
     */
    @ApiModelProperty(value = "资源介绍", position = 8)
    ...
    @ApiModelProperty(value = "资源类型，1：视频，2：ppt，3：pdf，4:实训", position = 9)
    ...
    @ApiModelProperty(value = "资源文件ID", position = 10)
    private Long fileId;
    ...
    @ApiModelProperty(value = "资源文件扩展名", position = 11)
    ...
    @ApiModelProperty(value = "资源大小 单位：秒（视频），页数（pdf/ppt）", position = 12)
