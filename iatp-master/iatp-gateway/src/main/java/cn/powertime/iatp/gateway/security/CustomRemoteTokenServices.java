package cn.powertime.iatp.gateway.security;

import cn.powertime.iatp.gateway.exception.ErrorCode;
import cn.powertime.iatp.gateway.exception.ServerException;
    ...
    public void loadAuthentication(String accessToken) {
        ...
        if(postForMap.containsKey(ERROR)) {
            ...
            if(code == HttpStatus.UNAUTHORIZED) {
                ...
                throw new ServerException(HttpStatus.UNAUTHORIZED, new ErrorCode(401, "UNAUTHORIZED", "登录已过期，请重新登录！"));
            }else {
